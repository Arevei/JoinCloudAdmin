...
export default {
  async fetch(request, env) {
    ...
    // Call Control Plane resolve endpoint
    ...
    // Fetch from tunnel — tunnel URL never leaves the Worker
    ...
    // Stream back to browser — preserving content-type and content-disposition
